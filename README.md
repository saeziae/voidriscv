...
| keepassxc |  |  |
| kemoticons |  |  |
| kernel-libc-headers | MISSING | patched by saeziae |
| kernelshark |  |  |
| kexec-tools |  |  |
| kexi |  |  |
| keybase-desktop |  |  |
...
| linux6.1 | MISSING |  |
| linux6.10 |  |  |
| linux6.11 | MISSING | patched by saeziae |
| linux6.6 |  |  |
| linuxwave |  |  |
| liquid-dsp |  |  |
| liquidwar |  |  |
...
| merkuro |  |  |
| mesa-demos |  |  |
| mesa | MISSING | patched by saeziae |
| meson-cmake-wrapper |  |  |
| meson |  |  |
| messagelib |  |  |
| metacity |  |  |
...
| openjdk-common |  |  |
| openjdk |  |  |
| openjdk10-bootstrap | MISSING |  |
| openjdk11 | MISSING |  |
| openjdk12-bootstrap | MISSING |  |
| openjdk13-bootstrap | MISSING |  |
| openjdk14-bootstrap | MISSING |  |
| openjdk15-bootstrap | MISSING |  |
| openjdk16-bootstrap | MISSING |  |
| openjdk17 | MISSING |  |
| openjdk18-bootstrap | MISSING |  |
| openjdk19-bootstrap | MISSING |  |
| openjdk20-bootstrap | MISSING |  |
| openjdk21 | MISSING |  |
| openjdk7-bootstrap | MISSING |  |
| openjdk8 | MISSING |  |
| openjdk9-bootstrap | MISSING |  |
| openjpeg |  |  |
| openjpeg2 |  |  |
| openldap |  |  |
| openmpi |  |  |
...
| perl-Email-FolderType |  |  |
| perl-Email-LocalDelivery |  |  |
...
| perl-Pod-Coverage |  |  |
| perl-Pod-Parser |  |  |
| perl-Pod-Simple-Text-Termcap |  |  |
| perl-Probe-Perl |  |  |
| perl-Proc-Daemontools |  |  |
| perl-Proc-Govern |  |  |
| perl-Proc-PID-File |  |  |
...
| pim-data-exporter |  |  |
| pimcommon |  |  |
| pinebookpro-base | MISSING |  |
| pinebookpro-firmware | MISSING |  |
| pinebookpro-kernel | MISSING |  |
| pinebookpro-uboot | MISSING |  |
| pinentry-bemenu |  |  |
| pinentry-dmenu |  |  |
| pinentry-gtk |  |  |
| pinentry |  |  |
| pinephone-base | MISSING |  |
| pinephone-kernel | MISSING |  |
| pinephone-uboot | MISSING |  |
| pinfo |  |  |
| pingus |  |  |
| pinktrace | MISSING |  |
| pioneer |  |  |
...
| python3-pytest-cov |  |  |
| python3-pytest-fixture-config |  |  |
| python3-pytest-flake8 |  |  |
| python3-pytest-forked |  |  |
| python3-pytest-httpbin |  |  |
| python3-pytest-httpserver |  |  |
| python3-pytest-import-check |  |  |
...
| python3-yarl |  |  |
| python3-yattag |  |  |
| python3-youtube-search |  |  |
| python3-youtubesearch |  |  |
| python3-ytmusicapi |  |  |
| python3-zc.lockfile |  |  |
| python3-zeroconf |  |  |
| python3-zipfile-deflate64 |  |  |
| python3-zipp |  |  |
...
| qrencode |  |  |
| qrintf |  |  |
| qscintilla-qt5 | MISSING |  |
| qscintilla-qt6 | MISSING |  |
| qsstv |  |  |
| qsudo |  |  |
| qsv | MISSING |  |
| qsynth |  |  |
...
| roccat-tools |  |  |
| rock64-base | MISSING |  |
| rock64-uboot | MISSING |  |
| rocker |  |  |
| rockpro64-base | MISSING |  |
| rockpro64-uboot | MISSING |  |
| rocksdb |  |  |
| rocksndiamonds |  |  |
| rofi-calc |  |  |
| rofi-emoji |  |  |
...
| rtaudio |  |  |
| rtkit |  |  |
| rtl8723bt-firmware | MISSING |  |
| rtl8812au-dkms | MISSING |  |
| rtl8821au-dkms | MISSING |  |
| rtl8821cu-dkms | MISSING |  |
| rtl8822bu-dkms | MISSING |  |
| rtl_433 |  |  |
| rtmidi |  |  |
| rtmpdump |  |  |
| rtorrent |  |  |
...
| texlive-science |  |  |
| texlive | MISSING |  |
| texlive2014-bin | MISSING |  |
| texlive2016-bin | MISSING |  |
| texlive2017-bin | MISSING |  |
| texlive2018-bin | MISSING |  |
| texlive2019-bin | MISSING |  |
| texlive2020-bin | MISSING |  |
| texlive2021-bin | MISSING |  |
| texlive2022-bin | MISSING |  |
| texlive2023-bin | MISSING |  |
| texlive2024-bin | MISSING |  |
| texmaker |  |  |
| texstudio | MISSING |  |
| text-engine |  |  |
| textadept |  |  |
...
| void-live-audio |  |  |
| void-release-keys |  |  |
| void-repo-bootstrap | MISSING |  |
| void-repo-multilib |  |  |
| void-repo-nonfree | MISSING |  |
| void-updates |  |  |
| vokoscreenNG |  |  |
| volctl |  |  |
| volk |  |  |
...
| xorg-server |  |  |
| xorg-util-macros |  |  |
| xorg-video-drivers | MISSING | patched by saeziae |
| xorg |  |  |
| xorgproto |  |  |
| xoris |  |  |
| xorriso |  |  |
